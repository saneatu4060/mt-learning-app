...
const Learning = () => {
    ...
    return (
        <div className="flex">
            <button
                className="fixed top-4 left-4 z-50 p-2 bg-blue-600 text-white rounded-full lg:hidden"
            ...
            <div className="w-full max-w-3xl mx-auto p-4 sm:p-6 lg:p-8"> {/* 幅を増やして中央に寄せる */}
                <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-lg p-6 sm:p-8 lg:p-10"> {/* 背景の透明度を調整 */}
                    <div className="flex justify-between items-center mb-4 sm:mb-6">
                        <Link href={`/learning/${categoryId}?name=${encodeURIComponent(categoryName)}`} className="text-gray-600 hover:text-gray-900 text-sm">
                            ← 選択画面へ
                        </Link>
                    </div>
